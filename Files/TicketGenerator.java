...
public class TicketGenerator {
    ...
    public static void generateTicket(Booking b) throws IOException, SQLException {
        ...
        try {
            ...
            txt(cb, enNF, 9,  DARK_BLUE, 20, y + 22, "Cairo (CAI)");
            ...
            txt(cb, enNF, 9,  DARK_BLUE, 190, y + 22, trip.getTo());
            ...
            txt(cb, enBF, 8, DARK_BLUE, stubX + 10, sy,
                    b.getName_passenger().toUpperCase());
            sy -= 18;
            ...
            doc.close();
            System.out.println("Ticket generated: ticket_" + b.getBookingId() + ".pdf");
    ...
    private static void fillRect(PdfContentByte cb, float x, float y,
                                 float w, float h, float r, BaseColor c) {
        cb.saveState();
        cb.setColorFill(c);
    ...
    private static void txt(PdfContentByte cb, BaseFont bf, float size,
                            BaseColor color, float x, float y, String text) {
        cb.saveState();
        cb.beginText();
    ...
    private static void dashedLine(PdfContentByte cb,
